...
exports.signup = catchAsync(async (req, res, next) => {
  // there is a flaw with code as any one can give themselves a role they wanted in the body

  // const newUser = await User.create(req.body);

  //actual way of authentication
...
exports.login = catchAsync(async (req, res, next) => {
  ...
  //12345678===$2b$12$2oykCQpwdSCUqk7sxCMZwOxs9BWcjrxFsMl62Mpj0WaH6H3vMEGXu
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  //3 update changedPasswordAt property for the user in the middleware
